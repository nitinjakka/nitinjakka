#!/usr/bin/env bash
# ===========================================================
#  Robinhood SELL-ALL - sells your ENTIRE position in a symbol
#  Usage:  ./sell_all.sh SOL
#  WARNING: places the order IMMEDIATELY - no confirmation prompt.
# ===========================================================
set -e
cd "$(dirname "$0")"

if [ -z "$1" ]; then
    echo "Usage: ./sell_all.sh SYMBOL"
    echo "Example: ./sell_all.sh SOL"
    exit 1
fi
